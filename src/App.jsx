...
function App() {
  ...
  const products = [
    ...
    },
    {
      ...
      price: '$70.00',
      image: 'https://images.unsplash.com/photo-1515446134809-993c501ca304?w=400&h=500&fit=crop',
      tag: null
    },
    {
      id: 4,
  ...
  const features = [
    ...
    { icon: <svg className="w-8 h-8 mx-auto" viewBox="0 0 24 24" fill="none" stroke={colors.brown} strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" /></svg>, title: 'Lab Tested', desc: 'Rigorous purity checks' },
    { icon: <svg className="w-8 h-8 mx-auto" viewBox="0 0 24 24" fill="none" stroke={colors.brown} strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>, title: 'WA & CA Made', desc: 'Locally crafted' }
  ]
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
                ...
                <p className="text-white/80 mb-8 max-w-md">
                  Fresh frozen live extracts. Solventless hash and rosin crafted with care in Washington and California.
                </p>
                <button 
      ...
      <section id="about" className="py-16 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            ...
            We're focused on providing you the best quality and cleanest products. We are based out of Washington but have a 
            California Branch as well and look forward to expanding to multiple States.
          </p>
          <div className="flex flex-wrap justify-center gap-3">
            {['100% Organic', 'Solventless', '6-Star Full Melt', 'Lab Tested'].map((tag) => (
              <span 
                key={tag}
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center text-white">
              ...
              <div>
                ...
                <p className="text-sm">Seattle, WA & California</p>
              </div>
            </div>
          </div>
        </div>
